...
public partial class InputEntity {
    ...
    public Source.Scripts.Gameplay.Input.AxisInput axisInput { get { return (Source.Scripts.Gameplay.Input.AxisInput)GetComponent(InputComponentsLookup.AxisInput); } }
    ...
    public InputEntity AddAxisInput(UnityEngine.Vector2 newValue) {
        ...
        var component = (Source.Scripts.Gameplay.Input.AxisInput)CreateComponent(index, typeof(Source.Scripts.Gameplay.Input.AxisInput));
