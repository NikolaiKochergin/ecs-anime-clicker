...
public partial class GameEntity {
    ...
    public Source.Scripts.Gameplay.Features.Income.Period period { get { return (Source.Scripts.Gameplay.Features.Income.Period)GetComponent(GameComponentsLookup.Period); } }
    ...
    public GameEntity AddPeriod(float newValue) {
        ...
        var component = (Source.Scripts.Gameplay.Features.Income.Period)CreateComponent(index, typeof(Source.Scripts.Gameplay.Features.Income.Period));
