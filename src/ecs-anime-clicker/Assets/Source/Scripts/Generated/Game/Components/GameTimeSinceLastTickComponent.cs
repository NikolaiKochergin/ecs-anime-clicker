...
public partial class GameEntity {
    ...
    public Source.Scripts.Gameplay.Features.Income.TimeSinceLastTick timeSinceLastTick { get { return (Source.Scripts.Gameplay.Features.Income.TimeSinceLastTick)GetComponent(GameComponentsLookup.TimeSinceLastTick); } }
    ...
    public GameEntity AddTimeSinceLastTick(float newValue) {
        ...
        var component = (Source.Scripts.Gameplay.Features.Income.TimeSinceLastTick)CreateComponent(index, typeof(Source.Scripts.Gameplay.Features.Income.TimeSinceLastTick));
